...
@section('content')
    ...
    <div class="container mt-5">
        <h1 class="text-center">Lab Sosial Ekonomi</h1>
        
        <!-- Pindahkan gambar ke dalam container setelah navbar -->
        <div class="text-center mt-3">
            <img src="{{ asset('assets/img/sosialekonomi.jpg') }}" alt="Lab Tanah dan Air" class="img-fluid">
        </div>
    ...
    @include('labs.tempat_sosial_ekonomi') {{-- Gunakan @include jika hanya ingin menyertakan kontennya --}}
@endsection
